    ...
    private void onDefineCustomItems(PackEventContext<GeyserDefineCustomItemsEvent, ItemPackModule> context) {
        ...
        for (Item item : items) {
            ...
            if (item instanceof ArmorItem armorItem) {
                // TODO Implement protection Value
                //List<ItemAttributeModifiers.Entry> modifiers = armorItem.components().get(DataComponents.ATTRIBUTE_MODIFIERS).modifiers();
                //customItemBuilder.protectionValue(armorItem.components().get(DataComponents.ATTRIBUTE_MODIFIERS).modifiers());
                ...
                Block block = BuiltInRegistries.BLOCK.getValue(itemLocation);
